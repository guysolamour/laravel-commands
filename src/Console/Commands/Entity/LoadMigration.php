...
class LoadMigration extends BaseEntity
{
/**
     * @var string
     */
    ...
    {
       return (new LoadMigration($name,$fields,$slug,$timestamps))
            ->loadMigrations();
    }
    ...
    protected function loadMigrations()
    {
        try {
            ...
            $migrations = [
                [
                    'stub' => $this->TPL_PATH . '/migration/provider.stub',
            ...
            foreach ($migrations as $migration) {
                ...
                [$result,$seed_file] = $this->createMigration($seed_fields, $seeder, $data_map);
                $this->registerSeed();

                if($result){

                    return [true,$migration['path'],$seed_file];
                }

                return [false,$migration['path'],$seed_file];
    ...
    {
        $seed_stub = file_get_contents($this->TPL_PATH . '/migration/seed.stub');
     ...
     * @return mixed
     */
    protected function createMigration($seed_fields, $seeder, $data_map) :array
    {
        $seed_mw_bait = 'create([';
